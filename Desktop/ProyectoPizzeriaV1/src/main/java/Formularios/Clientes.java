...
public class Clientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID_Cliente", "Nombre", "Direccion", "Correo", "Telefono"
            }
        ) {
    ...
    private void llenarTablaClientes() {
        ...
        try (Connection conn = ConexionGeneral.obtenerConexion()) {
            String query = "SELECT id_customer, name, address, email, phone_number FROM customer";
            PreparedStatement stmt = conn.prepareStatement(query);
            ResultSet rs = stmt.executeQuery();

            while (rs.next()) {
                Object[] fila = {rs.getString("id_customer"), rs.getString("name"), rs.getString("address"), rs.getString("email"), rs.getString("phone_number")};
                modelo.addRow(fila);
            }
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(this, "Error al obtener los datos de los clientes: " + ex.getMessage());
        }
    }
